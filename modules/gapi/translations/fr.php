...
$_MODULE['<{gapi}prestashop>gapi_0851f7a0844553fa1168718de0f87262'] = 'La directive allow_url_fopen est désactivée';
...
$_MODULE['<{gapi}prestashop>gapi_8c3d59ec958045d2138efbf189fc0b3d'] = 'Rendez-vous sur https://code.google.com/apis/console et cliquez sur le bouton \\"Créer un projet...\\"';
$_MODULE['<{gapi}prestashop>gapi_d1e3e532408766651e81db385118d7e9'] = 'Dans l\'onglet \\"Services\\", activez l\'API Analytics';
$_MODULE['<{gapi}prestashop>gapi_8075da7f240d2fa5cb5df57aa199ad13'] = 'Il vous sera demandé d\'accepter les conditions de service des API Google';
$_MODULE['<{gapi}prestashop>gapi_2cafb0c89afb28b57e86d6020fdd20e8'] = 'Et les conditions de service de l\'API Analytics';
$_MODULE['<{gapi}prestashop>gapi_6489ed26701b74c0fb139a3368804121'] = 'Vous devrez obtenir quelque chose comme cela';
$_MODULE['<{gapi}prestashop>gapi_55fdafff0d00bf5ce524ff4239126a57'] = 'dans l\'onglet "Accès API", cliquez sur le gros bouton "Créer un identifiant de client OAuth 2.0" bleu';
$_MODULE['<{gapi}prestashop>gapi_f68e4897a344f746740672c299f9c38d'] = 'Remplissez le formulaire avec le nom de la boutique, l\'URL de votre logo et l\'URL de votre boutique, puis cliquez sur "Suivant"';
$_MODULE['<{gapi}prestashop>gapi_3ba0cb1f9445416b1ea908245488f4ec'] = 'Laissez "Application Web" sélectionné et remplissez la zone "URI de redirections autorisées" avec cette URL : %s (vous pouvez devoir cliquer le lien "plus d\'options). Puis valider en cliquant sur le bouton "Créer un ID client"';
...
$_MODULE['<{gapi}prestashop>gapi_3360d865f7470f7e584792548dc8b87a'] = 'Il vous faut maintenant l\'ID du Profil Analytics que vous connecter. Pour trouver l\'ID du profil, connectez-vous au tableau de bord Analytics et regardez l\'URL dans la barre d\'adresse. Votre ID de profil est le nombre suivi d\'un "p", comme souligné dans la capture d\'écran';
