...
<div class="now_import_accessories">
	<p>{l s='The import module of accessories allows you to connect a product with one or more accessories.' mod='now_import_accessories'}</p>
	<p>{l s='To begin, please import a. CSV file.' mod='now_import_accessories'}</p>
