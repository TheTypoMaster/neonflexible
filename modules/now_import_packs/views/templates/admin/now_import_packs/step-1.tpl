...
<div class="now_import_packs">
	<p>{l s='The import module of products packs allows you to connect a product with one or more products which form a pack of products.' mod='now_import_packs'}</p>
	<p>{l s='To begin, please import a. CSV file.' mod='now_import_packs'}</p>
