...
<script type="text/javascript">
	...
	var admin_import_stock_link     = "{Context::getContext()->link->getAdminLink('AdminNowImportProductType', true)}";
</script>

<div id="steps">
	<div {if $selected == 1}class="selected"{/if}>
		{if $selected > 1}
			<a href="{Context::getContext()->link->getAdminLink('AdminNowImportProductType', true)}&step=1">
	...
	<div {if $selected == 2}class="selected"{/if}>
		{if $selected > 2}
			<a href="{Context::getContext()->link->getAdminLink('AdminNowImportProductType', true)}&step=2&file_name={$file_name}">
