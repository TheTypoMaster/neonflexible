...
<body {if isset($page_name)}id="{$page_name|escape:'htmlall':'UTF-8'}"{/if} class="{if isset($page_name)}{$page_name|escape:'htmlall':'UTF-8'}{/if}{if $hide_left_column} hide-left-column{/if}{if $hide_right_column} hide-right-column{/if}{if $content_only} content_only{/if}">
	...
	<div id="myCarousel" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner">
			<div class="item active">
				<img data-src="{$js_dir}example/holder.js/900x500/auto/#777:#7a7a7a/text:First slide" alt="First slide">
				<div class="container">
			...
			<div class="item">
				<img data-src="{$js_dir}example/holder.js/900x500/auto/#666:#6a6a6a/text:Second slide" alt="Second slide">
				<div class="container">
					<div class="carousel-caption">
			...
			<div class="item">
				<img data-src="{$js_dir}example/holder.js/900x500/auto/#555:#5a5a5a/text:Third slide" alt="Third slide">
				<div class="container">
					<div class="carousel-caption">
	...
	<div class="container marketing">
		...
		<div class="row">
			<div class="col-lg-4">
				<img class="img-circle" data-src="{$js_dir}example/holder.js/140x140" alt="Generic placeholder image">
				<h2>Heading</h2>
		...
		<div class="row featurette">
			...
			<div class="col-md-5">
				<img class="featurette-image img-responsive" data-src="{$js_dir}example/holder.js/500x500/auto" alt="Generic placeholder image">
			</div>
		</div>
