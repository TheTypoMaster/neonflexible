		...
		<div id="idTab1" class="tab-pane active">
			...
			{if $canSendInvitations}
				...
				<form method="post" action="{$link->getModuleLink('referralprogram', 'program', [], true)|escape:'html':'UTF-8'}" class="std">
					...
					<p class="submit">
						<button type="submit" id="submitSponsorFriends" name="submitSponsorFriends" class="btn btn-default button button-medium"><span>{l s='Validate' mod='referralprogram'}<i class="icon-chevron-right"></i></span></button>
					</p>
				</form>
			{else}
