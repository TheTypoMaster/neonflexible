			...
			<fieldset>
				...
				<div class="form_content clearfix">
					...
					<p class="submit cart_navigation">
						...
						<button type="submit" id="SubmitLogin" name="SubmitLogin"  class="button btn btn-default standard-checkout button-medium">
							<span>{l s='Authentication'}</span>
						</button>
					</p>
			...
			<fieldset>
				...
				<div class="form_content clearfix">
					...
					<p class="submit cart_navigation">
						...
						<button type="submit" id="SubmitCreate" name="SubmitCreate" class="button btn btn-default standard-checkout button-medium">
		...
		{if isset($inOrderProcess) && $inOrderProcess && $PS_GUEST_CHECKOUT_ENABLED}
			<form action="{$link->getPageLink('authentication', true, NULL, "back=$back")|escape:'html'}" method="post" id="new_account_form" class="std clearfix">
				...
				<p class="cart_navigation required submit">
					...
					<button type="submit" name="submitGuestAccount" id="submitGuestAccount" class="button btn btn-default standard-checkout button-medium">
	...
	{else}
		...
		<form action="{$link->getPageLink('authentication', true)|escape:'html'}" method="post" id="account-creation_form" class="std">
			...
			<p class="cart_navigation required submit">
				...
				<button type="submit" name="submitAccount" id="submitAccount" class="button btn btn-default standard-checkout button-medium">
					<span>{l s='Register'}</span>
				</button>
			</p>

			<p><sup>*</sup>{l s='Required field'}</p>
		</form>
	{/if}
