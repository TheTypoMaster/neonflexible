			...
			<fieldset>
				...
				<div class="form_content clearfix">
					...
					<p class="submit">
						...
						<input type="submit" id="SubmitLogin" name="SubmitLogin" class="button-rose" value="{l s='Authentication'}" />
					</p>
				</div>
			</fieldset>
		</form>
			...
			<fieldset>
				...
				<div class="form_content clearfix">
					...
					<p class="submit">
						...
						<input type="submit" id="SubmitCreate" name="SubmitCreate" class="button-rose" value="{l s='Create an account'}" />
